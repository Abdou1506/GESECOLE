...
if(isset($_POST['id_matiere']) && isset($_POST['id_prof'])){
    try{
        ...
        $r=$cnx->prepare("insert into cour(id_matiere,id_prof) values(?,?)");
        //execution de la requete 
        $r->execute([$id_matiere,$id_prof]);
...
try{
    ...
    $cnx->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    //preparation de la requette sql
     $r=$cnx->prepare("SELECT c.id_cour,m.id_matiere,m.nommatiere,p.prenom,p.nom FROM matiere m JOIN cour c on c.id_matiere=m.id_matiere JOIN prof p on p.id_prof=c.id_prof ");
    //ouverture de la connexion
    $r->execute();
    $resultat=$r->fetchall();
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
              ...
              <h1 class="m-0 text-dark">Ajouter un cour </h1>
        <!-- /.col -->
...
<form  action="store.php" method="POST">
  <div class="row">
      <div class="col-md-6 mx-auto mt-4">
       ...
       <table class="table table-dark table-hover" id="cour" border="1">
            <thead>
                    <tr>
          ...
          <tbody>
            <tr>
                <td scope="col"><?=$ligne['id_matiere']?></td>
