...
<body>
 ...
 <tbody>
    <tr>
      <td scope="row"><?= $c['id_prof'] ?></td>
      <td><?= $c['prenom'] ?></td>
      <td><?= $c['nom'] ?></td>
      <td><?= $c['email'] ?></td>
      
      <td> 
        <a href="delete.php?id_prof=<?= $c['id_prof'] ?>" class="btn btn-danger" onclick="return confirm('supprimer?')"><i class="fas fa-trash"></i> </a>
         <a  href="edit.php?id_prof=<?= $c[
             'id_prof'
