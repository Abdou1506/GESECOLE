...
<div class="content-wrapper">
 ...
 <tbody>
    <tr>
      ...
      <td> 
        <a href="../delete.php?id_etudiant" class="btn btn-danger"  onclick="return confirm('supprimer?')"><i class="fa-solid fa-pencil"></i></a>
                <a  href="edit.php?id_etudiant=<?=$c['id_etudiant']?>" class="btn btn-success"><i class="fa fa-edit"></i></a></td>
