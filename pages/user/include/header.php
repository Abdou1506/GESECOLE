...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="#" class="nav-link">Bienvenue dans admin</a>
        </li>
    </ul>
                ...
                <li class="nav-item has-treeview menu-open">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            ...
                            <a href="../user/etudiant/create.php" class="nav-link" id="bouton_ajouter">
                            <button class="btn btn-success">   <i class="fas fa-plus nav-icon"></i> &nbsp;  Ajouter etudiant</button>
                            </a>

                        </li>
                        <li class="nav-item">
                            <a href="../user/prof/create.php" class="nav-link">
                            <button class="btn btn-success"> <i class="fa fa-plus nav-icon"></i>
                             Ajouter prof</button>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="../user/classe/create.php" class="nav-link">
                            <button class="btn btn-success"> <i class="fa fa-plus nav-icon"></i>
                             Ajouter classe</button>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="../user/cour/create.php" class="nav-link">
                            <button class="btn btn-success"> <i class="fa fa-plus nav-icon"></i>
                             Ajouter cour</button>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="../user/prof/index.php" class="nav-link">
                            <button class="btn btn-success"> <i class="fa fa-plus nav-icon"></i>
                             liste des prof</button>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="../user/classe/index.php" class="nav-link">
                            <button class="btn btn-success"> <i class="fa fa-plus nav-icon"></i>
